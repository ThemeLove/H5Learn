      ...
      <div class="food" v-show="showFlag" ref="food">
        <div class="food-content">
          ...
          <div class="rating">
            ...
            <ratingselect v-bind:select-data="selectData"  v-bind:desc="desc" v-bind:ratings="food.ratings"></ratingselect>
    ...
    export default {
        ...
        methods :{
          ...
          needShow (rateType,rateText){
            if(this.selectData.onlyContent&&!rateText){
                return false;
            }
            if(this.selectData.selectType===ALL){
                return true;
            }else{
              return rateType===this.selectData.selectType;
            }
          }
        }
    }
